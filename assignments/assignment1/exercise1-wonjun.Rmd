...
dir_data <- "~/Dropbox/research_data/health/HCRIS-Ian/data"

df_HCRIS96 <- read.table(paste0(dir_data,"/output/HCRIS_Data_v1996.txt"), sep = '\t', header=TRUE)
df_HCRIS10 <- read.table(paste0(dir_data,"/output/HCRIS_Data_v2010.txt"), sep = '\t')
df_pos <- read.csv(paste0(dir_data,"/output/pos-data-combined2.csv"))
```
